...
public class GuiSolderingIron extends GuiForestry<ContainerSolderingIron> {
	...
	public void init() {
		...
		addRenderableWidget(new Button(leftPos + 12, topPos + 10, 12, 18, Component.literal("<"), b -> ContainerSolderingIron.regressSelection(0), null));
		addRenderableWidget(new Button(leftPos + 130, topPos + 10, 12, 18, Component.literal(">"), b -> ContainerSolderingIron.advanceSelection(0), null));
	}
